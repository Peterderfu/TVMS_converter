...
["10","CentOS 7 伺服器安全基準檢核表步驟-10","密碼原則","密碼最小長度","PASS_MIN_LEN設為12"],\
["11","CentOS 7 伺服器安全基準檢核表步驟-11","密碼原則","可嘗試密碼次數","retry設為3"],\
["12","CentOS 7 伺服器安全基準檢核表步驟-12","密碼原則","密碼必須至少包含數字個數","dcredit設為1"],\
["13","CentOS 7 伺服器安全基準檢核表步驟-13","密碼原則","密碼必須至少包含大寫字母個數","ucredit設為1"],\
["14","CentOS 7 伺服器安全基準檢核表步驟-14","密碼原則","密碼必須至少包含小寫字母個數","lcredit設為1"],\
["15","CentOS 7 伺服器安全基準檢核表步驟-15","密碼原則","密碼必須至少包含特殊字元個數","ocredit設為1"],\
