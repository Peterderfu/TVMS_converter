...
["1","CentOS伺服器安全基準檢核表步驟-01","CentOS伺服主機帳號及功能設定","Administrator帳號設定","確認僅root帳號之UID為0"],\
["2","CentOS伺服器安全基準檢核表步驟-02","CentOS伺服主機帳號及功能設定","SSH服務設定","確認UID小於UID_MIN之非root系統帳號的登入shell皆設為「/sbin/nologin」"],\
["3","CentOS伺服器安全基準檢核表步驟-03","CentOS伺服主機安全性設定","日誌檔輪替服務","編輯/etc/logrotate.d/syslog檔案新增或修改成以下內容：/var/log/messages /var/log/secure /var/log/maillog /var/log/spooler /var/log/boot.log /var/log/cron"],\
["4","CentOS伺服器安全基準檢核表步驟-04","CentOS伺服主機安全性設定","日誌檔檢視服務","啟用日誌檔檢視(logwatch)服務"],\
["5","CentOS伺服器安全基準檢核表步驟-05","CentOS伺服主機安全性設定","使用空白密碼之帳號登入方式","禁止使用空白密碼之帳號"],\
["6","CentOS伺服器安全基準檢核表步驟-06","CentOS伺服主機安全性設定","所有帳號的密碼遮蔽","確認沒有儲存密碼雜湊於/etc/passwd中"],\
["7","CentOS伺服器安全基準檢核表步驟-07","CentOS伺服主機安全性設定","密碼最短使用期限","PASS_MIN_DAYS設為1"],\
["8","CentOS伺服器安全基準檢核表步驟-08","CentOS伺服主機安全性設定","密碼到期前提醒使用者變更密碼","PASS_WARN_AGE設為14"],\
["9","CentOS伺服器安全基準檢核表步驟-09","CentOS伺服主機安全性設定","密碼最?使用期限","PASS_MAX_DAYS設為60"],\
["10","CentOS伺服器安全基準檢核表步驟-10","CentOS伺服主機安全性設定","密碼最小?度","PASS_MIN_LEN設為12"],\
["11","CentOS伺服器安全基準檢核表步驟-11","CentOS伺服主機安全性設定","可設定密碼次數","retry設為3"],\
["12","CentOS伺服器安全基準檢核表步驟-12","CentOS伺服主機安全性設定","密碼必須至少包含數字個數","dcredit設為1"],\
["13","CentOS伺服器安全基準檢核表步驟-13","CentOS伺服主機安全性設定","密碼必須至少包含大寫字母個數","ucredit設為1"],\
["14","CentOS伺服器安全基準檢核表步驟-14","CentOS伺服主機安全性設定","密碼必須至少包含小寫字母個數","lcredit設為1"],\
["15","CentOS伺服器安全基準檢核表步驟-15","CentOS伺服主機安全性設定","密碼必須至少包含特殊字元個數","ocredit設為1"],\
["16","CentOS伺服器安全基準檢核表步驟-16","CentOS伺服主機安全性設定","新密碼與舊密碼最少相異字元數","difok設為3"],\
["17","CentOS伺服器安全基準檢核表步驟-17","CentOS伺服主機安全性設定","強制執行密碼歷程記錄","remember設為24"],\
["18","CentOS伺服器安全基準檢核表步驟-18","CentOS伺服主機安全性設定","密碼雜湊演算法","密碼雜湊演算法設為sha512"],\
["19","CentOS伺服器安全基準檢核表步驟-19","CentOS伺服主機安全性設定","帳戶鎖定閾值","deny設為5"],\
["20","CentOS伺服器安全基準檢核表步驟-20","CentOS伺服主機安全性設定","auditd服務","啟用auditd服務(chkconfig auditd on)"],\
["21","CentOS伺服器安全基準檢核表步驟-21","CentOS伺服主機安全性設定","記錄變更日期與時間事件","記錄變更日期與時間事件( -k time-change)"],\
["22","CentOS伺服器安全基準檢核表步驟-22","CentOS伺服主機安全性設定","記錄變更使用者或群組資訊事件","記錄變更使用者或群組資訊之事件(-k identity)"],\
["23","CentOS伺服器安全基準檢核表步驟-23","CentOS伺服主機安全性設定","記錄變更系統網路環境事件","記錄變更系統網路環境之事件(-k system-locale)"],\
["24","CentOS伺服器安全基準檢核表步驟-24","CentOS伺服主機安全性設定","記錄變更系統強制性存取控制事件","記錄變更系統強制性存取控制事件(-k MAC-policy)"],\
["25","CentOS伺服器安全基準檢核表步驟-25","CentOS伺服主機安全性設定","記錄變更自主式存取控制權限事件","記錄變更自主式存取控制權限事件(-k perm_mod)"],\
["26","CentOS伺服器安全基準檢核表步驟-26","CentOS伺服主機安全性設定","記錄不成功的未經授權檔案存取","記錄不成功的未經授權檔案存取(-k access)"],\
["27","CentOS伺服器安全基準檢核表步驟-27","CentOS伺服主機安全性設定","記錄特權指令使用情形","記錄特權指令使用情形(-k privileged)"],\
["28","CentOS伺服器安全基準檢核表步驟-28","CentOS伺服主機安全性設定","記錄資料匯出至媒體","記錄資料匯出至媒體(-k export)"],\
["29","CentOS伺服器安全基準檢核表步驟-29","CentOS伺服主機安全性設定","記錄檔案刪除事件","記錄檔案刪除事件(-k delete)"],\
["30","CentOS伺服器安全基準檢核表步驟-30","CentOS伺服主機安全性設定","記錄系統管理者活動","記錄系統管理者活動(-k actions)"],\
["31","CentOS伺服器安全基準檢核表步驟-31","CentOS伺服主機安全性設定","記錄核心模組掛載與卸載事件","記錄核心模組掛載與卸載事件(-k modules)"],\
["32","CentOS伺服器安全基準檢核表步驟-32","CentOS伺服主機安全性設定","auditd設定不變模式","/etc/audit/audit.rules最後一行設為「-e 2」"],\
["33","CentOS伺服器安全基準檢核表步驟-33","CentOS伺服主機安全性設定","記錄變更登入與登出資訊事件","記錄變更登入與登出資訊事件(-k logins)"],\
["34","CentOS伺服器安全基準檢核表步驟-34","CentOS伺服主機安全性設定","記錄程序與會談啟始資訊","記錄程序與會談啟始資訊(-k session)"],\
["35","CentOS伺服器安全基準檢核表步驟-35","CentOS伺服主機安全性設定","螢幕保護裝置設定(GNOME螢幕保護裝置逾時)","idle_delay設為15"],\
["36","CentOS伺服器安全基準檢核表步驟-36","CentOS防火牆設定程序","iptables服務","啟用iptables服務(chkconfig iptables on)"],\
["37","CentOS伺服器安全基準檢核表步驟-37","CentOS防火牆設定程序","INPUT與FORWARD防火牆規則鏈的預設規則","將INPUT與FORWARD防火牆規則鏈預設規則變更為DROP"],\
["38","CentOS伺服器安全基準檢核表步驟-38","CentOS防火牆設定程序","IP轉送","於/etc/sysctl.conf中設定net.ipv4.ip_forward = 0"],\
["39","CentOS伺服器安全基準檢核表步驟-39","CentOS防火牆設定程序","所有網路介面傳送ICMP重新導向封包","於/etc/sysctl.conf中設定net.ipv4.conf.all.send_redirects=0"],\
["40","CentOS伺服器安全基準檢核表步驟-40","CentOS防火牆設定程序","預設網路介面傳送ICMP重新導向封包","於/etc/sysctl.conf中設定net.ipv4.conf.default.send_redirects = 0"],\
["41","CentOS伺服器安全基準檢核表步驟-41","CentOS防火牆設定程序","所有網路介面接受安全的ICMP重新導向封包","於/etc/sysctl.conf中設定net.ipv4.conf.all.secure_redirects = 0"],\
["42","CentOS伺服器安全基準檢核表步驟-42","CentOS防火牆設定程序","預設網路介面接受安全的ICMP重新導向封包","於/etc/sysctl.conf中設定net.ipv4.conf.default.secure_redirects = 0"],\
["43","CentOS伺服器安全基準檢核表步驟-43","CentOS防火牆設定程序","所有網路介面接受ICMP重新導向封包","於/etc/sysctl.conf中設定net.ipv4.conf.all.accept_redirects = 0"],\
["44","CentOS伺服器安全基準檢核表步驟-44","CentOS防火牆設定程序","預設網路介面接受ICMP重新導向封包","於/etc/sysctl.conf中設定net.ipv4.conf.default.accept_redirects = 0"],\
["45","CentOS伺服器安全基準檢核表步驟-45","CentOS防火牆設定程序","所有網路介面接受來源路由封包","於/etc/sysctl.conf中設定net.ipv4.conf.all.accept_source_route = 0"],\
["46","CentOS伺服器安全基準檢核表步驟-46","CentOS防火牆設定程序","預設網路介面接受來源路由封包","於/etc/sysctl.conf中設定net.ipv4.conf.default.accept_source_route = 0"],\
["47","CentOS伺服器安全基準檢核表步驟-47","CentOS防火牆設定程序","忽略偽造的ICMP錯誤訊息","於/etc/sysctl.conf中設定net.ipv4.icmp_ignore_bogus_error_responses = 1"],\
["48","CentOS伺服器安全基準檢核表步驟-48","CentOS防火牆設定程序","不回應ICMP廣播要求","於/etc/sysctl.conf中設定net.ipv4.icmp_echo_ignore_broadcasts = 1"],\
["49","CentOS伺服器安全基準檢核表步驟-49","CentOS防火牆設定程序","紀錄可疑封包","於/etc/sysctl.conf中設定net.ipv4.conf.all.log_martians = 1"],\
["50","CentOS伺服器安全基準檢核表步驟-50","CentOS防火牆設定程序","所有網路介面啟用逆向路徑過濾功能","於/etc/sysctl.conf中設定net.ipv4.conf.all.rp_filter = 1"],\
["51","CentOS伺服器安全基準檢核表步驟-51","CentOS防火牆設定程序","預設網路介面啟用逆向路徑過濾功能","於/etc/sysctl.conf中設定net.ipv4.conf.default.rp_filter = 1"],\
["52","CentOS伺服器安全基準檢核表步驟-52","CentOS防火牆設定程序","TCP SYN cookies","於/etc/sysctl.conf中設定net.ipv4.tcp_syncookies = 1"],\
["53","CentOS伺服器安全基準檢核表步驟-53","CentOS防火牆設定程序","無線網路介面卡","停用無線網路介面卡"],\
["54","CentOS伺服器安全基準檢核表步驟-54","CentOS時戳及校時(NTP)","設定NTP server","於/etc/ntp.conf中設定NTP server IP"]]
PASS_MIN_DAYS                               ='1'
PASS_WARN_AGE                               ='14'
PASS_MAX_DAYS                               ='60'
PASS_MIN_LEN                                ='12'
...
#     try:
#         book = openpyxl.load_workbook(infoTables[0],read_only=True,data_only=True)
#     except :
#         print(f'Unable to open {infoTables[0]}--', sys.exc_info()[0])
#         raise
    try:
...
#     fields_name = book['TVMS欄位']['A1':'O1'][0]
    fields_name = list(TVMS_HEADERS.values())
#     output_file.write(",".join([f.value for f in fields_name])+"\n")
    output_file.write(",".join(fields_name)+"\n")
#     N = book[infoTables[1]].max_row - 1
    N = len(INFO_TABLES) - 1
    global auditFunc
    for i in range(1,N+1):
        eval('auditFunc.append(' + f'getAudit{i:02}' + ')')
    
#     for row in book[infoTables[1]].iter_rows(min_row=2):
    for row in INFO_TABLES[2:]:
#         audit_id = row[0].value
        audit_id = int(row[0])
        ...
        if r[0]==False: # write to file if audit not passed
            result_list = {'A':log_time,
                           ...
                           'F':'GCB合規檢測',
                           'G':result,
#                            'H':row[2].value, # mapping to 弱點類別
                           'H':row[2],         # mapping to 弱點類別
                           'I':'',
#                            'J':row[1].value, # mapping to 評估工具原廠之弱點編號
                           'J':row[1], # mapping to 評估工具原廠之弱點編號
#                            'K':row[3].value, # mapping to 弱點說明
                           'K':row[3], # mapping to 弱點說明
                           'L':'',
#                            'M':row[4].value, # mapping to 弱點修補建議
